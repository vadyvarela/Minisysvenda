                  ...
                  <v-layout wrap>
                    ...
                    <div v-bind:key="index" v-for="(pd, index) in produtos">
                      ...
                      <div v-if="produtos[index].Produto">
                        <h4 >NOME: {{ produto.nome = produtos[index].Produto.produto_nome }}</h4>
                        <h4 >PREÇO: {{ produto.preco = produtos[index].Produto.produto_preco }}</h4>
                              ...
                              <v-flex xs12>
                                ...
                                <p class="red--text" style="text-align:center; font-size:2em;">
                                  <v-autocomplete
                                    ...
                                    label="Nome produto"
                                  ></v-autocomplete>
                                  <input name="" v-model="pd.search" type="hidden"/>   
                                </p>
                              </v-flex>
                            </v-layout>
                          </v-container>
