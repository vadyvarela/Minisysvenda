                ...
                <v-divider></v-divider>
                  ...
                  <div v-bind:key="index" v-for="(produto, index) in produtos">
                      ...
                      <!-- <div v-if="produto.idSearchNew == ''">
                        <h3 hidden>ID COMPRA: {{ produto.CompraId = idVenda }}</h3>
                      </div>
                      <div v-else>
                        <h3 hidden>ID COMPRA: {{ produto.CompraId = idSearch }}</h3>
                      </div> -->
                      ...
                      <v-navigation-drawer width="700" temporary fixed :clipped="clipped" v-model="left" enable-resize-watcher app right >
                       ...
                       <v-flex xs12 sm2 md2>
                          <div v-if="idSearch == '' && typeof produtos[index].Produto.produto_nome === 'undefined'">
