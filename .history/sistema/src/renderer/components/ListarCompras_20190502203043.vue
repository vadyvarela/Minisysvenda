                ...
                <v-divider></v-divider>
                  <v-layout wrap>
                    ...
                    <div v-bind:key="index" v-for="(pd, index) in produto">
                      ...
                      <div v-if="produto[index].ListaCompras && pd[index].ListaCompras.Iva">
                        <h4 >NOME: {{ pd.nome = produto[index].ListaCompras.produto_nome }}</h4>
                        <h4 >IVA: {{ produto.iva = produto[index].ListaCompras.Iva.iva_valor }}</h4>
                        <h4 >PREÇO: {{ produto.preco = produto[index].ListaCompras.produto_preco }}</h4>
                        <h4 >ID PRODUTO: {{ produto.ProdutoId = produto[index].ListaCompras.id }}</h4>
