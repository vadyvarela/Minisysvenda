                  ...
                  <v-layout wrap>
                    ...
                    <div v-bind:key="index" v-for="(pd, index) in produto">
                      ...
                      <div v-if="produto[index].Produto">
                        ...
                        <h4 >PESQUISA: {{ produto.search = produto[index].Produto.produto_nome }}</h4>
                        <h4 >PESQUISA: {{ produto.quantidade = produto[index].quantidade }}</h4>
            ...
            <v-card flat>
              ...
              <v-card-text>
                ...
                >
                  ...
                  <template slot="items" slot-scope="props"  v-if="props.item.ListaCompra !== null">
                   <td>{{ props.item.ListaCompra }}</td> 
