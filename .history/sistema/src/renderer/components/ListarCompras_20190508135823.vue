                ...
                <v-divider></v-divider>
                  ...
                  <div v-bind:key="index" v-for="(produto, index) in produtos.ListaCompras">
                      ...
                      <div v-if="produtos[index].Produto">
                        <h4 hidden>NOME: {{ produto.nome = produtos[index].ListaCompras.Produto.produto_nome }}</h4>
                        <h4 hidden>NOME: {{ produto.search = produtos[index].ListaCompras.Produto.produto_nome }}</h4>
