                ...
                >
                  ...
                  <v-expansion-panel popout>
                    <v-expansion-panel-content>
                      ...
                      <v-card>
                        <v-card-text> 
                          <tr class="nobordertr" v-bind:key="index" v-for="(produto,index) in props.item.ListaCompra">
                  ...
                  <td class="text-xs-left"> <span class="boxquantidadegreen"> {{ props.item.ListaCompra.Produto.produto_preco }} CVE </span></td>
                  <td class="text-xs-left"> <span class="boxquantidadered"> 0000 CVE </span> </td>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Preço", align: "left", sortable: false },
