          ...
          <v-card flat>
              ...
              <v-card-text>
                ...
                <v-layout v-if="total > 0 " justify-end row>
                  <v-flex text-lg-center xs12>
                    <v-badge class='mt-3 mr-4' right>              
                      <span style="font-size:5em" class="green--text title"> O VENDEDOR VENDEU HOJE </span>
                      <v-divider></v-divider> 
                ...
                <v-layout v-else justify-end row>
                  <v-flex text-lg-center xs12>
                    <v-badge class='mt-3 mr-4' right>              
                      <span style="font-size:6em" class="red--text title"> O VENDEDOR NÃO VENDEU NADA HOJE </span>
