                  ...
                  <div v-bind:key="index" v-for="(produto, index) in produtos">
                      ...
                      <v-dialog v-model="dialogPesquisa" persistent max-width="550px" @keydown.esc="dialogPesquisa = false">
                          <v-card align-center justify-center>
                            ...
                            <v-card-actions>
                              <v-spacer></v-spacer>
                              <v-btn center large color="primary darken-1" @click.native="dialogPesquisa = false; pesquisarProd(index)">OK</v-btn>
                            </v-card-actions>
                          </v-card>
                        </v-dialog>
  ...
  methods: {
    ...
    async pesquisarProd(index) {
      try {
        ...
        // console.log("TEST PROD " + this.produtos[index].Produto)
