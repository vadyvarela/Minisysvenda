        ...
        <v-card-text>
          <v-container>
                ...
                <v-divider></v-divider>
                  ...
                  <h2 >{{ produto.CompraId = idCompra }}</h2>
                  <div v-if="produtos[index].Produto && produtos[index].Produto.Iva">
                    <h4 hidden>NOME: {{ produto.nome = produtos[index].Produto.produto_nome }}</h4>
                    <h4 hidden>IVA: {{ produto.iva = produtos[index].Produto.Iva.iva_valor }}</h4>
