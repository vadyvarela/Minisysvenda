                  ...
                  <v-layout wrap>
                    ...
                    <div v-bind:key="index" v-for="(pd, index) in produto">
                      ...
                      <div v-if="produto[index].Produto">
                        ...
                        <h4 >QUANTIDADE: {{ produto.quantidade = produto[index].quantidade }}</h4>
          ...
          <v-container>
            ...
            <v-layout style="">
              ...
              <v-flex class="text-xs-right" xs12 sm3 md3>
                <span style="font-size:2.4em; font-weight:300; margin-right:8px" class="text-xs-right white--text"> {{ totalPrice }}: </span>
