                ...
                <v-layout v-if="total > 0 " justify-end row>
                  <v-flex text-lg-center xs12>
                    <v-badge class='mt-3 mr-4' right>              
                      <span style="font-size:4em" class="green--text title"> O VENDEDOR {{ filtroV }} VENDEU HOJE </span>
                      <v-divider></v-divider> 
                      
                      <span style="font-size:6em" class="TVenda"> {{ totalIva }} CVE </span>
                    </v-badge>
                  </v-flex>
                </v-layout>

                <v-layout v-else justify-end row>
                  <v-flex text-lg-center xs12>
                    <v-badge class='mt-3 mr-4' right>              
                      <span style="font-size:6em" class="red--text title"> O VENDEDOR NÃO VENDEU NADA HOJE <b>{{ filtro }}</b>  </span>
                      
                      <span class="TNVenda"> {{ 0 }} </span>
                    </v-badge>
                  </v-flex>
                </v-layout>
