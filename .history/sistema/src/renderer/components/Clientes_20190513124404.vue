...
export default {
  data() {
    return {
      ...
      dialog: false,
      headers: [
        { text: "Nome Cliente ", value: 'fornecedor_nome', align: "left", sortable: true },
        { text: "Morada", value: 'fornecedor_nif', align: "center", sortable: true },
        { text: "Telefone", value: 'fornecedor_endereco', sortable: true },
