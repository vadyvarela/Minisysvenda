                ...
                <v-divider></v-divider>
                  ...
                  <div v-bind:key="index" v-for="(produto, index) in produtos">
                      ...
                      <div hidden v-else-if="produto.Produto && !produto.Produto.Fornecedore">
                        <h3>ID Pesquisa: {{ produto.idSearch = idCompra }}</h3>
                        <h4>ID PRODUTO: {{ produto.ProdutoId = produto.Produto.id }}</h4>
                      </div>
...
export default {
  ...
  methods: {
    ...
    async updateCompraProd() {
      /*listaCompraServices.put(this.produtos);*/
      ...
      try {
        ...
        if (this.search !== '') {
          ...
          Object.keys(this.produtos[index].Produto).forEach(key => {
            ...
            if (this.produtos[index].Produto.Stock.quantidade === 0) {
              this.dialogStock = true
            }
          });
      ...
      try {
        ...
        if (this.search !== '') {
          ...
          Object.keys(this.produtos[banana].Produto).forEach(key => {
            ...
            if (this.produtos[banana].Produto.Stock.quantidade === 0) {
              this.dialogStock = true
            }
          });
