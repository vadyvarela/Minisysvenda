                  ...
                  <v-layout wrap>
                    ...
                    <div v-bind:key="index" v-for="(produto, index) in produtos">
                      ...
                      <div v-if="produtos[index].idProduto && produtos[index].idProduto.Iva">
                        ...
                        <h4 >PREÇO: {{ produto.preco = produtos[index].idProduto.produto_preco }}</h4>
...
export default {
  ...
  methods: {
    ...
    editCompra: function(item) {
      ...
      console.log("DADOS P:  ", this.produto = Object.assign({}, item));
      console.log("Teste ", this.produto.ListaCompras)
      this.dialog = true;
