          ...
          <v-card flat>
              ...
              <v-card-text>
                ...
                <v-layout v-if="total == null " justify-end row>
                  <v-flex text-lg-center xs12>
                    <v-badge class='mt-3 mr-4' right>              
                      <span style="font-size:4em" class="blue--text"> SELECIONE O VENDEDOR PARA FILTRAR O FECHO DIÁRIO </span>
                    </v-badge>
                  </v-flex>
                </v-layout>
                ...
                <v-layout style="margin-bottom:100px" v-if="total > 0 " row>
                  <v-flex text-lg-center xs12>
                    <v-badge class='mt-3 mr-4' right>              
                      <span style="font-size:3em" class="green--text"> O VENDEDOR VENDEU HOJE </span>
                      <v-divider></v-divider> 
                      <span style="font-size:3em" class="TVenda"> {{ totalIva }} CVE </span>
                    </v-badge>
                  </v-flex>
                </v-layout>
                ...
                <v-layout v-if="total == 0" justify-end row>
                  <v-flex text-lg-center xs12>
                    <v-badge class='mt-3 mr-4' right>              
                      <span style="font-size:3em" class="red--text"> O VENDEDOR NÃO VENDEU NADA HOJE </span>
                      <v-divider></v-divider> 
