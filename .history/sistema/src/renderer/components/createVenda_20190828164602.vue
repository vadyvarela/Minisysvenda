                  ...
                  <v-layout class="layoutmeu">                    
                    ...
                    <v-flex flex xs12 sm2 md2>
                      <v-layout flex class="layoutmeu">
                        ...
                        <v-flex xs12 sm12 md12>
                          <v-text-field class="styled-input" id="styled-input" box v-model.trim="produto.search" ref="search" autofocus v-on:keyup.enter="pesquisar(index)" type="text"></v-text-field>
