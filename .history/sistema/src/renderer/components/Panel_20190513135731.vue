 ...
 <div v-if="isOnline">
    <div v-if="user.nivel == 1">
          ...
          <v-toolbar flat class="transparent">
            <v-list class="pa-0">
              <v-list-tile avatar>
                ...
                <v-list-tile-content>
                  <v-list-tile-title class="text-uppercase font-weight-bold" > {{ user.usuario }} - {{ Vady }} </v-list-tile-title>
                </v-list-tile-content>
              </v-list-tile>
            </v-list>
          </v-toolbar>
      ...
      <v-toolbar color="primary" dark fixed app>
          ...
          <!--<v-btn deep-orange class="deep-orange" v-on:click="switchLocale()"><v-icon>language </v-icon>  {{ displayLocale }}</v-btn>-->
        </v-toolbar>
    </div>
