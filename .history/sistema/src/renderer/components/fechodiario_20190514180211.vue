          ...
          <v-card flat>
              ...
              <v-card-text>
                ...
                <v-layout style="margin-bottom:100px" v-if="total > 0 " row>
                  <v-flex text-lg-center xs12>
                    <v-badge class='mt-3 mr-4' right>              
                      <span style="font-size:3em" class="green--text"> O VENDEDOR VENDEU HOJE </span><br>
                ...
                <v-layout style="margin-bottom:100px" v-if="total == 0" justify-end row>
                  <v-flex text-lg-center xs12>
                    <v-badge class='mt-3 mr-4' right>              
                      <span style="font-size:3em" class="red--text"> O VENDEDOR NÃO VENDEU NADA HOJE </span><br>
