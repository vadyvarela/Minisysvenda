                ...
                <v-form @submit.prevent="submit" ref="form" name="cadastar" autocomplete="off" lazy-validation>
                  ...
                  <v-layout wrap>
                    <div hidden v-if="this.produto.idProduto && this.produto.idProduto.Iva">
                      ...
                      <h4>IVA: {{ produto.IvaId = this.produto.idProduto.Iva.iva_valor }}</h4>
                      <h4>FORNECEOR: {{ produto.FornecedoreId = this.produto.idProduto.Fornecedore.fornecedor_nome }}</h4>
                      <h4>CATEGORIA: {{ produto.CategoriaId = this.produto.idProduto.Categoria.categoria_nome }}</h4>
                    </div>
                    <div v-else>
