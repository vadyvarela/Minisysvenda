    ...
    async createVendaProdnoPrinter(banana) {
      if (this.pagamento.troco < 0) {
        ...
        try{
          ...
          // Create nova venda
          this.meuloading = true
          VendaServices.post(this.venda)
          this.idVenda = (VendaServices.lastid()).data[0].id;
          this.meuloading = false

          this.recibo = (VendaServices.index({
              userId: this.user.id
          })).data[0].ListaVendas;
    ...
    async createVendaProd(banana) {
      if (this.pagamento.troco < 0) {
        ...
        try{
          ...
          console.log("Dados Pag:", this.pagamento);
          ...
          this.valorVenda = (await VendaServices.index({
            ...
            console.log("RECI", this.valorVenda)
