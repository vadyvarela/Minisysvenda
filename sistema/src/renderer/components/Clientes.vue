              ...
              <v-card-text>
                <v-container grid-list-md>
                  <v-form ref="form" name="cadastar" autocomplete="off" v-model="valid" lazy-validation>
                    <v-text-field box append-icon="account_circle" required :rules="nameRules" v-model="cliente.cliente_nome" label="Nome do cliente" type="text"></v-text-field>
                    ...
                    <v-text-field box append-icon="home" required :rules="enderecoRules" v-model="cliente.cliente_morada" label="Morada do cliente" type="text"></v-text-field>
                    <v-text-field box append-icon="smartphone" required :rules="contatoRules" v-model="cliente.cliente_telefone" label="Contato do cliente" type="number"></v-text-field>
                  </v-form>
                </v-container>
              </v-card-text>
              <v-card-actions>
